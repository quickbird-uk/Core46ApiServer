...
namespace Qb.Poco.User
{
    public class SensorHistory
    {
        ...
        /// <summary>This methos slices the SensorHistory item in two, and produces an entirely new item which only includes time
        ///     stamps taken after time requested.</summary>
